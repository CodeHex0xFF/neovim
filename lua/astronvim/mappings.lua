...
if is_available("toggleterm.nvim") then
	...
	if vim.fn.executable("scapy") == 1 then
		maps.n["<leader>tn"] = {
			function()
				utils.toggle_term_cmd("scapy")
			end,
			desc = "ToggleTerm scapy",
		}
	end
	if vim.fn.executable("btop") == 1 then
		maps.n["<leader>tt"] = {
			function()
				utils.toggle_term_cmd("btop")
			end,
	...
	if vim.fn.executable("sqlite3") == 1 then
		maps.n["<leader>sql"] = {
			function()
				utils.toggle_term_cmd("sqlite3")
			end,
			desc = "ToggleTerm sqlite3",
		}
	end
