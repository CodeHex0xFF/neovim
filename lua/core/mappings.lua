...
if is_available "toggleterm.nvim" then
  ...
  if vim.fn.executable "gitui" == 1 then
    maps.n["<leader>gg"] = { function() toggle_term_cmd "gitui" end, desc = "ToggleTerm gitui" }
    maps.n["<leader>tl"] = { function() toggle_term_cmd "gitui" end, desc = "ToggleTerm gitui" }
  end
  if vim.fn.executable "sqlite3" == 1 then
    maps.n["<leader>tn"] = { function() toggle_term_cmd "sqlite3" end, desc = "ToggleTerm sqlite3" }
  end
